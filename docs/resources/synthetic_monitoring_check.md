...
page_title: "Resource grafana_synthetic_monitoring_check - terraform-provider-grafana"
subcategory: ""
description: |-
...
- **alert_sensitivity** (String) Can be set to `none`, `low`, `medium`, or `high` to correspond to the check [alert levels](https://grafana.com/docs/grafana-cloud/synthetic-monitoring/synthetic-monitoring-alerting/). Defaults to `none`.
