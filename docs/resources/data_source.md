...
- `private_datasource_connect_network_id` (String) (Can only be used with data sources in Grafana Cloud) The ID of the private data source network to use with this data source. Defaults to ``.
