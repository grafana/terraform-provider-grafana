...
- `certificate` (String) Base64-encoded string for the SP X.509 certificate.
...
- `name` (String) Name used to refer to the SAML authentication. Defaults to `SAML`.
...
- `private_key` (String) Base64-encoded string for the SP private key.
