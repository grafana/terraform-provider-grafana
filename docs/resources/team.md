...
- `admins` (Set of String) A set of email addresses corresponding to users who should be given admin status to the team. Note: users specified here must already exist in Grafana.
