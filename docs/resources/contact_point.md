...
- `oncall` (Block List) A contact point that sends notifications to Grafana OnCall. (see [below for nested schema](#nestedblock--oncall))
...
- `url` (String, Sensitive) The OnCall webhook URL.
