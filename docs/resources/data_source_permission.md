...
- `built_in_role` (String) Name of the basic role to manage permissions for. Defaults to `""`. Options: `Viewer`, `Editor` or `Admin`. Can only be set from Grafana versions 9.2.3+.
