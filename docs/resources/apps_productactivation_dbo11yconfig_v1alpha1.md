...
page_title: "grafana_apps_productactivation_dbo11yconfig_v1alpha1 Resource - terraform-provider-grafana"
subcategory: "Cloud"
description: |-
...
# grafana_apps_productactivation_dbo11yconfig_v1alpha1 (Resource)
...
```terraform
resource "grafana_apps_productactivation_dbo11yconfig_v1alpha1" "example" {
  metadata {
    uid = "global"
  }
...
- `enabled` (Boolean) Whether database observability is enabled.
...
terraform import grafana_apps_productactivation_dbo11yconfig_v1alpha1.example my-db-o11y-config
```
