...
var knownReferences = []string{
	...
	"grafana_apps_playlist_playlist_v0alpha1.value=grafana_apps_dashboard_dashboard_v1.metadata",
	"grafana_apps_playlist_playlist_v0alpha1.value=grafana_apps_dashboard_dashboard_v1alpha1.metadata",
	"grafana_apps_playlist_playlist_v1.value=grafana_apps_dashboard_dashboard_v1.metadata",
