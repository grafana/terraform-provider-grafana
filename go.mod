...
require (
	...
	// TODO: https://github.com/grafana/grafana-openapi-client-go/pull/31 needs to be merged and released and ref changed here
	github.com/grafana/grafana-openapi-client-go v0.0.0-20231115171053-680b3d45ee91
