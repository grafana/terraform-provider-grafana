...
replace github.com/grafana/terraform-provider-grafana/v3 v3.17.1 => ../
...
require (
	...
	github.com/grafana/grafana/apps/playlist v0.0.0-20250127114419-103a8f079332
	github.com/grafana/grafana/pkg/apimachinery v0.0.0-20250120114436-95d4f838898e
	github.com/grafana/terraform-provider-grafana/v3 v3.17.1
