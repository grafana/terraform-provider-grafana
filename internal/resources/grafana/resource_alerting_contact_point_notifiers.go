...
func (n pushoverNotifier) meta() notifierMeta {
	return notifierMeta{
		...
		fieldMapper: map[string]fieldMapper{
			...
			"ok_priority":  newFieldMapper("okPriority", valueAsInt, valueAsInt),
			"priority":     newFieldMapper("", valueAsInt, valueAsInt),
			"retry":        newFieldMapper("", valueAsInt, valueAsInt),
			"expire":       newFieldMapper("", valueAsInt, valueAsInt),
		},
	}
}
