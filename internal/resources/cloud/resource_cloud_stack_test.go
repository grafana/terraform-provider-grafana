...
func TestResourceStack_Basic(t *testing.T) {
	...
	firstStepChecks := resource.ComposeTestCheckFunc(
		...
		resource.TestCheckResourceAttrSet("grafana_cloud_stack.test", "alertmanager_private_connectivity_info_private_dns"),
		resource.TestCheckResourceAttrSet("grafana_cloud_stack.test", "alertmanager_private_connectivity_info_service_name"),
