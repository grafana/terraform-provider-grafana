...
func parseRecordingRuleSpec(ctx context.Context, src types.Object, dst *v0alpha1.RecordingRule) diag.Diagnostics {
	...
	if !data.Expressions.IsNull() && !data.Expressions.IsUnknown() {
		...
		for ref, obj := range expressionsMap {
			exprData, diags := parseRecordingRuleExpressionModel(ctx, obj)
			if diags.HasError() {
				return diags
			}
...
func parseRecordingRuleExpressionModel(ctx context.Context, src types.Object) (v0alpha1.RecordingRuleExpression, diag.Diagnostics) {
