		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					// id
					resource.TestCheckResourceAttr("data.grafana_k6_project_limits.from_id", "vuh_max_per_month", "10000"),
					resource.TestCheckResourceAttr("data.grafana_k6_project_limits.from_id", "vu_max_per_test", "10000"),
					resource.TestCheckResourceAttr("data.grafana_k6_project_limits.from_id", "vu_browser_max_per_test", "1000"),
					resource.TestCheckResourceAttr("data.grafana_k6_project_limits.from_id", "duration_max_per_test", "3600"),
					// project_id
