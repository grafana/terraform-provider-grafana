...
│   ├── sdkv2-to-framework-migration.md ← Migrating existing SDKv2 resources/datasources
...
|----------|-------|----------|
| New REST-based resource | Plugin Framework | `agent-docs/resources/framework.md` |
| Migrating SDKv2 → Plugin Framework | Playbook | `agent-docs/resources/sdkv2-to-framework-migration.md` |
| Modifying existing OSS/Cloud/OnCall resource | SDKv2 | `agent-docs/resources/sdkv2.md` |
| New Grafana App Platform (K8s API) resource | AppPlatform | `agent-docs/resources/appplatform.md` |
| Understanding provider setup | Mux architecture | `agent-docs/provider/mux-architecture.md` |
| Adding/debugging API client | API clients | `agent-docs/provider/api-clients.md` |
| Writing acceptance tests | Testing | `agent-docs/testing/infrastructure.md` |
| Doc generation or import tool | Generation | `agent-docs/generation/systems.md` |
